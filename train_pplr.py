...
from pplr.utils.myserialization_fixmatch import load_checkpoint, copy_state_dict
...
def main_worker(args):
    ...
    # model
    num_part = args.part
    model = resnet50part(num_parts=args.part, num_classes=751*3)
    model.cuda()
    model = nn.DataParallel(model)

    # load a checkpoint
    checkpoint = load_checkpoint("model_best.pth")
