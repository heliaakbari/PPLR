...
from .transformer_layers import load_checkpoint
...
class TransReID(nn.Module):
    ...
    """
    def __init__(self, img_size=(256, 128), patch_size=16, stride_size=16, in_chans=3, num_classes=751, embed_dim=768, depth=12,num_heads=12, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop_rate=0., attn_drop_rate=0., camera=0, view=0,drop_path_rate=0., norm_layer=partial(nn.LayerNorm, eps=1e-6), local_feature=False, sie_xishu =1.0, hw_ratio=1, gem_pool = False, stem_conv=False):
        super().__init__()
...
def vit_base_patch16_224_TransReID(pretrained=True, pretrained_path=None, img_size=(256, 128), stride_size=16, drop_path_rate=0.1, camera=0, view=0,local_feature=False, sie_xishu=1.5, **kwargs):
...
def my_vit(pretrained=False, pretrained_path=None, **kwargs):
